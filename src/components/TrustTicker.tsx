...
export function TrustTicker() {
  return (
    <div className="py-10 bg-surface border-y border-surface-muted/10 overflow-hidden flex relative transition-colors duration-300">
      ...
      <div className="animate-marquee flex gap-24 items-center px-8 group">
        {[...logos, ...logos, ...logos].map((logo, i) => (
          <div key={i} className="flex items-center gap-3 text-surface-muted opacity-50 group-hover:opacity-20 hover:!opacity-100 hover:!text-surface-text transition-all duration-300 cursor-default">
